{{-- Untuk saat ini, kita bisa buat sama persis dengan guru, nanti bisa dikustomisasi --}}
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('student.assignments.index')" :active="request()->routeIs('student.assignments.index')">
                        {{ __('Tugas') }}
                    </x-nav-link>

                    <x-nav-link :href="route('student.grades.index')" :active="request()->routeIs('student.grades.index')">
                        {{ __('Rapor Online') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('student.materials.index')" :active="request()->routeIs('student.materials.index')">
                        {{ __('Materi Pelajaran') }}
                    </x-nav-link>
                </div>
            </div>
