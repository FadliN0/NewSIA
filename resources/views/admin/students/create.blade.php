                ...
                <form method="POST" action="{{ route('admin.students.store') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nis" id="nis" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('nis') }}" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="nisn" id="nisn" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('nisn') }}" required>
                        ...
                        <div>
                            ...
                            <input type="number" name="entry_year" id="entry_year" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('entry_year', date('Y')) }}" required>
                    ...
                    <div class="flex items-center justify-end mt-6">
                        ...
                        <button type="submit" class="px-4 py-2 bg-lime-accent text-white rounded-lg">Simpan Siswa</button>
                    </div>
                </form>
            </div>
        </div>
