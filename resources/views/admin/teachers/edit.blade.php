                ...
                <form method="POST" action="{{ route('admin.teachers.update', $teacher) }}">
                    ...
                    <h3 class="text-lg font-semibold mb-4 text-teal-dark">Informasi Akun</h3>
                     <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="email" name="email" id="email" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('email', $teacher->user->email) }}" required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="full_name" id="full_name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('full_name', $teacher->full_name) }}" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="nip" id="nip" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('nip', $teacher->nip) }}" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="phone" id="phone" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('phone', $teacher->phone) }}">
                        ...
                        <div>
                            ...
                            <input type="text" name="education_level" id="education_level" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('education_level', $teacher->education_level) }}">
                    ...
                    <div class="flex items-center justify-end mt-6">
                        ...
                        <button type="submit" class="px-4 py-2 bg-lime-accent text-white rounded-lg">Perbarui Guru</button>
                    </div>
                </form>
            </div>
        </div>
